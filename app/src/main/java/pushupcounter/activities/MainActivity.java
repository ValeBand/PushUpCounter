package pushupcounter.activities;
...
import pushupcounter.view.CountersListFragment;
import pushupcounter.view.Themes;
...
public class MainActivity extends AppCompatActivity {
  ...
  public boolean onKeyLongPress(int keyCode, KeyEvent event) {
    return super.onKeyLongPress(keyCode, event) || selectedCounterFragment.onKeyLongPress(keyCode, event);
  }
  @Override
